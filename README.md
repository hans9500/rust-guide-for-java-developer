...
| 17 | 동시성 | thread, Arc, Mutex, mpsc 채널, Send/Sync |
| 18 | 더 깊은 Rust | Drop, From/Into, Rc, RefCell, Cow |
| 19 | 전체 예제 | 도서관 관리 시스템 (s1~s18 통합) |
| 20 | 마무리 | 다음 단계 안내 |
...
- **SVG 다이어그램**: 인라인 SVG (2시간 가이드 44개, 전체 가이드 포함)
